...
import { Search, Filter, Calendar, Clock, CheckCircle, XCircle, TruckIcon } from "lucide-react"
...
export default function OrdersPage() {
  ...
  const orders = [
    {
      ...
      products: [{ id: "SHOE-001", name: "Nike Air Force 1 '07", quantity: 1, price: "1,299,000đ" }],
    ...
    },
    {
      ...
      products: [{ id: "SHOE-002", name: "Adidas Ultraboost 22", quantity: 1, price: "2,499,000đ" }],
    ...
    },
    {
      ...
      products: [{ id: "SHOE-003", name: "Converse Chuck Taylor All Star", quantity: 1, price: "899,000đ" }],
    ...
    },
    {
      ...
      order_status: "Đã hủy",
      products: [
        { id: "SHOE-004", name: "Vans Old Skool", quantity: 2, price: "1,890,000đ" },
        { id: "SHOE-005", name: "New Balance 990v5", quantity: 1, price: "2,109,000đ" },
        { id: "SHOE-006", name: "Converse Chuck Taylor", quantity: 3, price: "1,590,000đ" },
      ],
    ...
    },
    {
      ...
      order_status: "Đã giao",
      products: [
        { id: "SHOE-001", name: "Nike Air Force 1 '07", quantity: 1, price: "1,799,000đ" },
        { id: "SHOE-007", name: "Adidas Stan Smith", quantity: 2, price: "1,299,000đ" },
      ],
  ...
  const getStatusBadge = (status: string, orderId: string) => {
    ...
    return (
      <Select defaultValue={config.value} onValueChange={(value) => handleStatusChange(orderId, value)}>
        <SelectTrigger className={`w-auto h-7 text-xs ${config.className} rounded-full font-medium border-0 px-3`}>
          <SelectValue />
        </SelectTrigger>
        <SelectContent>
    ...
    if (products.length === 1) {
      return (
        <div className="flex items-center">
          ...
          <span className="text-xs text-muted-foreground"> x{products[0].quantity}</span>
        </div>
      )
    }
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{orders.filter((o) => o.order_status === "Đã tiếp nhận").length}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{orders.filter((o) => o.order_status === "Đã giao").length}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{orders.filter((o) => o.order_status === "Đã hủy").length}</div>
        ...
        <CardContent>
          <Tabs defaultValue="all" className="mb-4">
            <TabsList>
              ...
              <TabsTrigger value="received">Đã tiếp nhận</TabsTrigger>
                ...
                <TableRow key={order.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-sm">{order.shipping_fee}</span>
                    </div>
                  </TableCell>
                  <TableCell>{getStatusBadge(order.order_status, order.id)}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
